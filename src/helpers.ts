...
export const isObject = (val: any): val is object => val !== null && toTypeString(val) === 'Object'

export const isDate = (val: any): val is Date => toTypeString(val) === 'Date'

export const isRegexp = (val: any): val is Date => toTypeString(val) === 'RegExp'
...
export const isArrayBuffer = (val: any): val is ArrayBuffer => toTypeString(val) === 'ArrayBuffer'

export const isBlob = (val: any): val is Blob => toTypeString(val) === 'Blob'

export const isFormData = (val: any): val is FormData => toTypeString(val) === 'FormData'
